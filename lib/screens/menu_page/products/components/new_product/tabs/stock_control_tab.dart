            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: FormBuilderTextField(
                  ...
                  onChanged: (val) {
                    setState(() {
                      _reorderPointHasError = !(_formKey
                              .currentState?.fields['reorderPoint']
                              ?.validate() ??
                          false);
                    });
                  },
              ...
              SizedBox(
                ...
                child: FormBuilderTextField(
                  ...
                  onChanged: (val) {
                    setState(() {
                      _preferredQuantityHasError = !(_formKey
                              .currentState?.fields['preferredQuantity']
                              ?.validate() ??
                          false);
                    });
                  },
              ...
              SizedBox(
                ...
                child: FormBuilderTextField(
                  ...
                  onChanged: (val) {
                    setState(() {
                      _lowStockWarningQuantityHasError = !(_formKey
              ...
              TextButton(onPressed: () {}, child: Text('Reset to default'))
            ],
          ),
        ),
      ),
