...
class ImageAndColor extends StatefulWidget {
  final formKey;
  const ImageAndColor({required this.formKey, super.key});
...
class _ImageAndColorState extends State<ImageAndColor> {
  ...
  final bool _costHasError = false;
  final bool _markupHasError = false;
  final bool _salePriceHasError = false;
  ...
  Uint8List? fileBytes;
  String _pathText = '';
  dynamic imageFile = const NetworkImage('');
